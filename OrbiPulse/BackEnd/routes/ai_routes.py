...
def get_all_insights(_: UserPublic = Depends(_current_user)):
    """
    ...
    **all valves** that have telemetry data.
    ...
    """
    return ai_service.get_insights_all_valves()
...
def get_valve_insights(
    ...
    """
    return ai_service.get_insights_for_valve(valve_id, limit=limit)
